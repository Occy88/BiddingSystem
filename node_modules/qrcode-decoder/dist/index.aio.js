/* @preserve
 * qrcode-decoder 0.1.0 (https://github.com/yugasun/qrcode-decoder)
...
(function (global, factory) {
	...
	_export(_export.S + _export.F, 'Object', { assign: assign });
	...
	var require$$0 = ( _sameValue$1 && _sameValue ) || _sameValue$1;

	// 19.1.3.10 Object.is(value1, value2)

	_export(_export.S, 'Object', { is: require$$0 });
	...
	_export(_export.P, 'Function', { bind: bind });
	...
	_export(_export.G + _export.F * (parseInt != $parseInt$1), { parseInt: $parseInt$1 });
	...
	_export(_export.G + _export.F * (parseFloat != $parseFloat$1), { parseFloat: $parseFloat$1 });
	...
	_export(_export.S + _export.F * (Number.parseFloat != $parseFloat$1), 'Number', { parseFloat: $parseFloat$1 });

	// 20.1.2.13 Number.parseInt(string, radix)
	_export(_export.S + _export.F * (Number.parseInt != $parseInt$1), 'Number', { parseInt: $parseInt$1 });
	...
	var QrcodeDecoder = function () {
	    ...
	    _createClass(QrcodeDecoder, [{
	                                                    ...
	                                                    switch (_context3.prev = _context3.next) {
	                                                        case 0:
	                                                            ...
	                                                            if (videoElem.videoWidth && videoElem.videoHeight) {
	                                                                ...
	                                                                code = jsQR$1(imageData.data, imageData.width, imageData.height, options);
	        ...
	        value: function _decodeFromImageElm(imgObj) {
	            ...
	            var code = jsQR$1(imageData.data, imageData.width, imageData.height, opts);
